...
public class ProfessorService {
    ...
    public List<Professors> getAllProfessors(){return professorRepository.findAll();}

    public Optional<Professors> getProfessorById(Integer Id){return professorRepository.findById(Id);}
